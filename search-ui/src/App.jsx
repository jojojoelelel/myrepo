...
// Get configurations from search-ui/.env
const apiKey = import.meta.env.VITE_REACT_APP_Encoded_API_Key;
const host = import.meta.env.VITE_REACT_APP_Elasticsearch_Host;

// Intialise connector to Elasticsearch service
...
const config = {
  ...
  // Load when the connector is initialised
  alwaysSearchOnInitialLoad: true,
  // Use the connector to connect to Elasticsearch service API
...
export default function App() {
  return (
    // SearchProvider is the main component that provides search context to its children
    <SearchProvider config={config}>
    {/* WithSearch provides search context to its children */}
    <WithSearch mapContextToProps={({ wasSearched }) => ({ wasSearched })}>
      {({ wasSearched }) => (
        // Main container
        <div className="App" style={{ display: "flex" }}>
          {/* Content container that holds the search box and results */}
